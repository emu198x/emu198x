...
//! `commodore_denise_ocs::DeniseEcs`. This module is the narrow wiring
//! layer that the machine uses to:
//!
//!   - dispatch custom-register writes into `DeniseEcs::write_word`
...
impl Denise {
    ...
    /// Thin forwarder into `DeniseEcs::write_word`.
    ...
    /// `self.ocs` now; this is a convenience for the AmigaEcs
