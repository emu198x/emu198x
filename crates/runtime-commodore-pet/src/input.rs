...
fn key_from_name(name: &str) -> Option<PetKey> {
    Some(match name.to_ascii_lowercase().as_str() {
        ...
        "down" | "crsr-down" => PetKey::CursorDown,
        "home" | "clr" | "clear" => PetKey::Home,
        "del" | "delete" | "inst" => PetKey::Delete,
        "shift" | "shift-left" => PetKey::ShiftLeft,
        "shift-right" => PetKey::ShiftRight,
        "rvs" | "rvs-off" => PetKey::RvsOff,
        "stop" | "run-stop" => PetKey::StopRun,
        ...
        "-" | "minus" => PetKey::Minus,
        "[" | "bracketleft" => PetKey::BracketLeft,
        "]" | "bracketright" => PetKey::BracketRight,
        "\\" | "backslash" => PetKey::Backslash,
        "^" | "up-arrow" | "caret" => PetKey::UpArrow,
        "left-arrow" | "back-arrow" => PetKey::LeftArrow,
        "@" | "at" => PetKey::At,
