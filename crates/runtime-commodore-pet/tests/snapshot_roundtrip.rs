//! Snapshot/restore round-trip coverage for the Commodore PET runtime.
//!
...
const MODEL: Model = Model::Pet40Col;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut PetRuntime, target: u64) {
    runtime
        .run_until(
...
fn snapshot_round_trip_preserves_live_state() {
    let mut runtime = PetRuntime::blank(MODEL);
