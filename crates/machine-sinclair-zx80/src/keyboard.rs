//! ZX80 keyboard.
//!
//! The ZX80 keyboard is an 8x5 matrix, identical in scanning to the ZX81 and
//! Spectrum. The high byte of the port address selects which half-rows to scan:
//! each bit (A8-A15) enables one half-row. Multiple rows can be scanned
