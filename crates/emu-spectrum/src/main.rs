...
struct Renderer {
    ...
    #[allow(dead_code)] // needed for future resize support
...
impl Renderer {
    ...
    /// Convert ARGB32 framebuffer to RGBA8 and upload to the GPU texture.
    fn upload_framebuffer(&mut self, fb: &[u32]) {
