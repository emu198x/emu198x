...
//!
//! 64-entry standard RP2C02 NTSC palette. Each entry is ARGB32
//! (`0xAARRGGBB`). The PPU indexes into this table after applying
//! greyscale masking and RGB emphasis attenuation.
