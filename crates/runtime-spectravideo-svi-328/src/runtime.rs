...
impl Svi328Runtime {
    ...
    /// Whether a cartridge is held by this runtime, including before firmware loads.
    #[must_use]
...
impl emu198x_shell::FamilyRuntime for Svi328Runtime {
    type Model = Model;
    ...
    fn rom_convention() -> emu198x_shell::RomConvention {
        emu198x_shell::RomConvention {
            env_var: Some("EMU198X_SVI_328_ROM_DIR"),
            dirs: &["spectravideo-svi-328"],
        }
    }
