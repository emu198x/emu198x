//! Snapshot/restore round-trip coverage for the Spectravideo SVI-328 runtime.
//!
...
const MODEL: Model = Model::Svi328Ntsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut Svi328Runtime, target: u64) {
    runtime
        .run_until(
