//! Snapshot/restore round-trip coverage for the Commodore VIC-20 runtime.
//!
...
const MODEL: Model = Model::Vic20Ntsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut Vic20Runtime, target: u64) {
    runtime
        .run_until(
...
fn snapshot_round_trip_preserves_live_state() {
    let mut runtime = Vic20Runtime::blank(MODEL);
