//! Snapshot/restore round-trip coverage for the Sinclair ZX81 runtime.
//!
...
const MODEL: Model = Model::Zx81;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut Zx81Runtime, target: u64) {
    runtime
        .run_until(
