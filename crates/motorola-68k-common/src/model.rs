...
impl CpuModel {
    /// Address bus mask. The 68000, 68010, and 68EC020 have a 24-bit
    /// external address bus ($00FFFFFF). All other 68020+ variants
    /// have a full 32-bit bus ($FFFFFFFF).
    #[must_use]
    pub const fn addr_mask(self) -> u32 {
        match self {
            Self::M68000 | Self::M68010 | Self::M68EC020 => 0x00FF_FFFF,
            _ => 0xFFFF_FFFF,
        }
    }
}
