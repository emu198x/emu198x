...
//!
//! A native Dragon 32/64 verifier window: shared `wgpu` video, live
//! PIA-derived audio, semantic keyboard input, gamepad-to-analogue
//! joystick, tape/cartridge/BIN/snapshot loading, and `--autoload`.
