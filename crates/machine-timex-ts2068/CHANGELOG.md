...
- Collapse held Z80 bus strobes so stateful AY writes are dispatched once per
  guest transaction.

## [0.2.0](https://github.com/emu198x/emu198x/releases/tag/machine-timex-ts2068-v0.2.0) - 2026-06-04
