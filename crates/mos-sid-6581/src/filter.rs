...
const FC_6581_TABLE: [f32; 32] = [
    0.0020, 0.0020, 0.0020, 0.0022, 0.0030, 0.0055, 0.0100, 0.0165, 0.0250, 0.0360, 0.0480,
    0.0600, 0.0730, 0.0860, 0.0990, 0.1120, 0.1250, 0.1380, 0.1510, 0.1640, 0.1770, 0.1900,
    0.2030, 0.2160, 0.2290, 0.2430, 0.2580, 0.2740, 0.2920, 0.3100, 0.3300, 0.3600,
];
