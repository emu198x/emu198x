//! Snapshot/restore round-trip coverage for the Sinclair ZX80 runtime.
//!
...
const MODEL: Model = Model::Zx80;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut Zx80Runtime, target: u64) {
    runtime
        .run_until(
