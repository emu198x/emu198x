...
## [0.2.0](https://github.com/emu198x/emu198x/releases/tag/machine-coleco-colecovision-v0.2.0) - 2026-06-04
...
- *(emu198x-colecovision)* headless runner + BIOS boot smoke
- *(machine-coleco-colecovision)* fresh-write machine wiring against pin-driven bus
