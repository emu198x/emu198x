//! Snapshot/restore round-trip coverage for the Memotech MTX runtime.
//!
...
const MODEL: Model = Model::Mtx500;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut MtxRuntime, target: u64) {
    runtime
        .run_until(
