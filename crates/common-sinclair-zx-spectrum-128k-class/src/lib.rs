...
//! memory + AY + beeper + tape composition shared across the
...
//! variants. It selects the interrupt profile at construction and restore,
//! but contributes no serialized state.
//!
