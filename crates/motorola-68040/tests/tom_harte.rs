//! Musashi-generated single-step harness for the 68040.
//!
...
//! of an instruction). `Cpu68040` wraps `Cpu68030`; this harness
...
fn harte_baseline_full_sweep() {
    ...
    if !root.exists() {
        emu198x_test_skip::skip!(
            "SingleStepTests 680040 corpus not staged: {}",
            root.display()
        );
    }
    ...
    println!();
    println!(
        "Musashi-generated MC68040 corpus ({} fixtures):",
        entries.len()
    );
