//! Snapshot/restore round-trip coverage for the Dragon 32 runtime.
//!
...
const MODEL: Model = Model::Dragon32Pal;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut DragonRuntime, target: u64) {
    runtime
        .run_until(
