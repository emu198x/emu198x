...
macro_rules! amiga_variant_query_paths {
    ...
    "chipset.output_ecsena_enabled",
    "chipset.output_extblken_enabled",
    ...
    "denise.delayed_color_write",
    "denise.pending_early_color_write",
    "denise.programmed_hblank_input",
    "denise.programmed_hblank_visible",
    "denise.programmed_hblank_pipeline",
    ...
    "dma.dmacon",
    "dma.dmacon_bits",
    "dma.dmacon_bits.BLTPRI",
    "dma.dmacon_bits.DMAEN",
    "dma.dmacon_bits.BPLEN",
    "dma.dmacon_bits.COPEN",
    "dma.dmacon_bits.BLTEN",
    "dma.dmacon_bits.SPREN",
    "dma.dmacon_bits.DSKEN",
    "dma.dmacon_bits.AUD3EN",
    "dma.dmacon_bits.AUD2EN",
    "dma.dmacon_bits.AUD1EN",
    "dma.dmacon_bits.AUD0EN",
    "dma.plan",
    "dma.plan.slot_owner",
    "dma.plan.slot_channel",
    "dma.plan.disk_dma_slot_granted",
    "dma.plan.sprite_dma_service_channel",
    "dma.plan.audio_dma_service_channel",
    "dma.plan.bitplane_dma_fetch_plane",
    "dma.plan.copper_dma_slot_granted",
    "dma.plan.cpu_chip_bus_granted",
    "dma.plan.blitter_chip_bus_granted",
    ...
    "dma.actual.blitter_nasty_owned_this_cck",
    "dma.actual.blitter_cck_bus_state_recorded",
    "dma.actual.blitter_authority",
    "dma.actual.blitter_holds_bus",
    "dma.ddf",
    "dma.ddf.vpos",
    "dma.ddf.hpos",
    "dma.ddf.agnus_id",
    ...
    "dma.ddf.stop_match",
    "dma.ddf.fetch_end",
    "dma.ddf.ocs_run_aborted",
    "dma.ddf.ocs_hard_start_open",
    "blitter.busy",
    ...
    "blitter.dpt",
    "blitter.registers",
    "blitter.registers.bltcon0",
    "blitter.registers.bltcon1",
    "blitter.registers.bltsize",
    "blitter.registers.bltsizv_ecs",
    "blitter.registers.bltsizh_ecs",
    "blitter.registers.blt_apt",
    "blitter.registers.blt_bpt",
    "blitter.registers.blt_cpt",
    "blitter.registers.blt_dpt",
    "blitter.registers.blt_amod",
    "blitter.registers.blt_bmod",
    "blitter.registers.blt_cmod",
    "blitter.registers.blt_dmod",
    "blitter.registers.blt_adat",
    "blitter.registers.blt_bdat",
    "blitter.registers.blt_cdat",
    "blitter.registers.blt_afwm",
    "blitter.registers.blt_alwm",
    "blitter.execution",
    "blitter.execution.agnus_id",
    "blitter.execution.original_revision",
    "blitter.execution.dmacon",
    "blitter.execution.dma_enabled",
    "blitter.execution.priority_enabled",
    "blitter.execution.busy",
    "blitter.execution.busy_visible",
    "blitter.execution.busy_copper",
    "blitter.execution.nasty_active",
    "blitter.execution.startup_ccks_remaining",
    "blitter.execution.completion_phase",
    "blitter.execution.final_write_address",
    "blitter.execution.final_write_value",
    "blitter.execution.completion_ccks_remaining",
    "blitter.execution.final_d_pending",
    "blitter.execution.finish_emitted",
    "blitter.execution.dmacon_busy_hold_ccks",
    "blitter.execution.copper_busy_hold_ccks",
    "blitter.execution.exec_pending",
    "blitter.execution.exec_ready",
    "blitter.execution.zero",
    "blitter.execution.height",
    "blitter.execution.width_words",
    "blitter.execution.ccks_remaining",
    "blitter.execution.next_dma_request",
    "blitter.execution.next_progress_uses_bus",
    "blitter.execution.word_complete",
    "blitter.execution.incremental_runtime_present",
    "blitter.word",
    "blitter.word.present",
    "blitter.word.need_a",
    "blitter.word.need_b",
    "blitter.word.need_c",
    "blitter.word.need_d",
    "blitter.word.reads_done",
    "blitter.word.internal_only",
    ...
    "blitter.line.error_sub",
    "blitter.line.cpt",
    "blitter.line.dpt",
    "blitter.line.pixel_bit",
    "blitter.line.row_mod",
    "blitter.line.texture",
    "blitter.line.texture_bit",
    "blitter.line.lf",
    "blitter.line.sing",
    "blitter.line.one_dot_drawn",
    "blitter.line.major_is_y",
    "blitter.line.x_negative",
    "blitter.line.y_negative",
    "blitter.line.last_c_word",
    ...
    "blitter.area.use_d",
    "blitter.area.lf",
    "blitter.area.a_shift",
    "blitter.area.b_shift",
    "blitter.area.descending",
    "blitter.area.pointer_step",
    "blitter.area.modulo_direction",
    "blitter.area.fill_enabled",
    "blitter.area.inclusive_fill_enabled",
    "blitter.area.exclusive_fill_enabled",
    "blitter.area.fill_carry_initial",
    "blitter.area.fill_carry",
    "blitter.area.apt",
    "blitter.area.bpt",
    "blitter.area.cpt",
    "blitter.area.dpt",
    ...
    "blitter.area.cmod",
    "blitter.area.dmod",
    "blitter.area.a_previous",
    "blitter.area.b_previous",
    "blitter.area.a_raw",
    "blitter.area.b_raw",
    "blitter.area.c_value",
    "paula.intena",
    "paula.intreq",
    "paula.adkcon",
...
const AGA_VARIANT_QUERY_PATHS: &[&str] = amiga_variant_query_paths!(
    ...
    "aga.delayed_color_write",
    "aga.pending_early_color_write",
