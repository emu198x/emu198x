...
//!
//! 1. `/RFSH` ends at `T3b` (Zilog: `T4b`).
//! 2. Memory read `/MREQ`, `/RD` end at `T2a` (Zilog: `T3b`).
//! 3. Memory write `/MREQ` ends at `T2b` and `/WR` runs `T2a`–`T2b`
//!    (Zilog: `T1b`–`T3b` and `T2b`–`T3b`).
//! 4. I/O `/IORQ` runs `T2a`–`TWa` (Zilog: `T2b`–`T3b`).
//!
