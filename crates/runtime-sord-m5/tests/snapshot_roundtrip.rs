//! Snapshot/restore round-trip coverage for the Sord M5 runtime.
//!
...
const MODEL: Model = Model::M5Ntsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut M5Runtime, target: u64) {
    runtime
        .run_until(
