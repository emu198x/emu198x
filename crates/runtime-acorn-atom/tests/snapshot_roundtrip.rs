//! Snapshot/restore round-trip coverage for the Acorn Atom runtime.
//!
...
const MODEL: Model = Model::AtomBase;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut AtomRuntime, target: u64) {
    runtime
        .run_until(
