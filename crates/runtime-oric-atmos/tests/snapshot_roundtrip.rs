//! Snapshot/restore round-trip coverage for the Oric Atmos runtime.
//!
...
const MODEL: Model = Model::Oric1;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut OricRuntime, target: u64) {
    runtime
        .run_until(
