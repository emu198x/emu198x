//! Snapshot/restore round-trip coverage for the Sega SG-1000 runtime.
//!
...
const MODEL: Model = Model::Sg1000Ntsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut Sg1000Runtime, target: u64) {
    runtime
        .run_until(
