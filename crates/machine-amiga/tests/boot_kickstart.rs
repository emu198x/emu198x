...
// Boot screenshot tests have been moved to per-chipset files:
// - boot_ocs.rs  (OCS: A500, A1000, A2000)
// - boot_ecs.rs  (ECS: A500+, A600, A3000)
// - boot_aga.rs  (AGA: A1200, A4000)
// Shared helper is in common/mod.rs.
