//! Snapshot/restore round-trip coverage for the MSX runtime.
//!
...
const MODEL: Model = Model::Msx1Ntsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut MsxRuntime, target: u64) {
    runtime
        .run_until(
