...
impl MemoryPentagon {
    ...
    /// `$7FFD` paging. Used by the runtime's screen-text decoder to
    /// reach the standard glyph table at `$3D00` of ROM 1
    /// (48 BASIC) regardless of which ROM is currently mapped at
