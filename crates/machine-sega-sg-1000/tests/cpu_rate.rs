...
//!
//! The SG-1000 carried the identical defect, down to a comment reading
//! "CPU half-cycle tick" directly above `cpu_tstates += 1`.
//!
//! Nothing caught it. The SG-1000 suite passed throughout: boot tests reach
...
fn a_nop_costs_four_tstates() {
    ...
    let mut sms = Sg1000::new(rom, Sg1000Region::Ntsc);
