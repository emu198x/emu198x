//! Snapshot/restore round-trip coverage for the ColecoVision runtime.
//!
...
const MODEL: Model = Model::CvNtsc;
const WARMUP: u64 = 50_000;
const LOCKSTEP: u64 = 100_000;

fn run_to(runtime: &mut CvRuntime, target: u64) {
    runtime
        .run_until(
