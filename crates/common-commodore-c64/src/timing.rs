...
//! - `knowledge/decisions/archives-as-source.md`
//! - Adapted from `../Emu198x-Older/crates/machine-commodore-c64/src/config.rs`
//! - Adapted from `../Emu198x-Older/crates/mos-vic-ii/src/lib.rs`
