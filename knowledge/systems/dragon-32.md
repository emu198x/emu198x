...
This page is a placeholder. Codex owns the detailed Dragon line of work; when it stabilises, this page should be replaced with a proper overview matching `knowledge/systems/commodore-c64.md` or `knowledge/systems/nintendo-game-boy/overview.md`.
...
- `knowledge/log.md` — the 2026-04-26 to 2026-04-28 entry summarises the family stand-up
