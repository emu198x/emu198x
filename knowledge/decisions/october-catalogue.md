...
> **Status (2026-06-03): Spectrum SOLID engineering bar MET**, ahead of the October public launch. The sequencing gate ("Spectrum SOLID first, then C64/NES/Amiga") is cleared — non-Spectrum and donor work is now the active engineering frontier, not deferred. Residual Spectrum items (strict Spectron PNG comparison for the 5 ULA smokes; Scorpion ZS-256 screen rendering; 4 FUSE block-I/O AF disagreements) are accuracy/scope debt, not blockers. See [`docs/status/outstanding-work.md`](../../docs/status/outstanding-work.md). RULES.md § Session start updated to match.
...
| 2026-06-03 | **Spectrum SOLID engineering bar MET**, ahead of the October public launch. The sequencing gate (Spectrum SOLID before C64/NES/Amiga and donor work) is cleared; non-Spectrum / donor work becomes the active engineering frontier. Residual Spectrum items (strict Spectron PNG comparison, Scorpion ZS-256 screen rendering, 4 FUSE block-I/O AF disagreements) are accuracy/scope debt, not blockers. RULES.md § Session start rewritten to retire the "deferred behind Spectrum" rule. |
