...
> The current system boots NROM, MMC1, UxROM, CNROM, MMC3, and AxROM cartridges through the shared
...
| iNES parser + NROM/MMC1/UxROM/CNROM/MMC3/AxROM mappers | `format-nintendo-nes-ines` | 52 | Validated |
...
- **Mapper unit coverage** — NROM, MMC1, UxROM, CNROM, MMC3, and AxROM parser/banking behaviour is covered in `format-nintendo-nes-ines`.

### What doesn't work yet

- **Mappers beyond NROM/MMC1/UxROM/CNROM/MMC3/AxROM** — the longer tail still lives in the archive and will be lifted when the real-game matrix needs it.
