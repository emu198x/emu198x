...
> The current system boots NROM, MMC1, UxROM, and CNROM cartridges through the shared
...
| iNES parser + NROM/MMC1/UxROM/CNROM mappers | `format-nintendo-nes-ines` | 37 | Validated |
...
- **Mapper unit coverage** — NROM, MMC1, UxROM, and CNROM parser/banking behaviour is covered in `format-nintendo-nes-ines`.
