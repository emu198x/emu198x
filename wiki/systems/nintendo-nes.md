...
> The current system boots NROM, MMC1, UxROM, CNROM, MMC3, AxROM, and BxROM/BNROM cartridges through the shared
...
| iNES parser + NROM/MMC1/UxROM/CNROM/MMC3/AxROM/BxROM mappers | `format-nintendo-nes-ines` | 56 | Validated |
...
- **Mapper unit coverage** — NROM, MMC1, UxROM, CNROM, MMC3, AxROM, and BxROM parser/banking behaviour is covered in `format-nintendo-nes-ines`.

### What doesn't work yet

- **Mappers beyond NROM/MMC1/UxROM/CNROM/MMC3/AxROM/BxROM** — the longer tail still lives in the archive and will be lifted when the real-game matrix needs it.
