...
### Nintendo NES
- [Overview](systems/nintendo-nes.md) — 2A03 CPU + 2C02 PPU + APU + Mapper wired, NROM/MMC1/UxROM support, master-clock tick loop, **nestest 8991/8991 passing**, **Super Mario Bros. renders**, `MachineCore` runtime integrated, `emu198x-nes` native verifier window available
...
- `format-nintendo-nes-ines` — iNES / NES 2.0 header parser + Mapper trait + NROM, MMC1, and UxROM.
