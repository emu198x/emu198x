...
### Commodore Amiga
- [Overview](systems/commodore-amiga.md) — OCS PAL runtime covering A1000 bootstrap/WOM and A500-family RAM profiles; Kickstart insert-disk, Workbench 1.3 desktop, native verifier window, DF0 `ADF` insertion, screenshots, Paula-backed audio capture, and scripted keyboard input
