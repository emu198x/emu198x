...
| `format-nintendo-nes-ines` (NROM/MMC1/UxROM/CNROM/MMC3/AxROM) | `Emu198x-archive/crates/format-nintendo-nes-ines/` | — | **Partially ported.** Started in Emu198x commit `dd76911`; mapper coverage now includes NROM (0), MMC1 (1), UxROM (2), CNROM (3), MMC3 (4), and AxROM (7). 52 tests. Remaining mappers stay in archive. |
