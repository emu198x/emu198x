...
| `format-nintendo-nes-ines` (NROM/MMC1/UxROM/CNROM/MMC3/AxROM/BxROM/Camerica) | `Emu198x-archive/crates/format-nintendo-nes-ines/` | — | **Partially ported.** Started in Emu198x commit `dd76911`; mapper coverage now includes NROM (0), MMC1 (1), UxROM (2), CNROM (3), MMC3 (4), AxROM (7), BxROM/BNROM (34), and Camerica/Codemasters (71). 60 tests. Remaining mappers stay in archive. |
