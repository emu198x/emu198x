...
| `format-nintendo-nes-ines` (NROM/MMC1/UxROM) | `Emu198x-archive/crates/format-nintendo-nes-ines/` | — | **Partially ported.** Started in Emu198x commit `dd76911`; mapper coverage now includes NROM (0), MMC1 (1), and UxROM (2). 31 tests. Remaining mappers stay in archive. |
