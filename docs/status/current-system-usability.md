...
| Commodore Amiga | `emu198x-amiga`, `emu198x-script-amiga` | Native OCS verifier window with keyboard/mouse input plus headless Kickstart/Workbench runner with A1000 and A500-family profiles, DF0 `ADF`, screenshots, Paula-backed audio capture, and scripted input. | Add joystick input and live native audio. |
...
3. Add Amiga joystick input and live native audio now that the native shell has mouse input.
