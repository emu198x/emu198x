...
| ------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| Amiga support-chip bring-up          | Needed to unblock broader Amiga compatibility and model coverage   | Gary, Buster-family, DMAC, and remaining bus glue have standalone implementations or clearly bounded stubs in place | `machine-amiga` integration, pin-level tests |
