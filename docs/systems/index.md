...
| System | Boot today | Timing | Drive | Net | Rachel |
|--------|-----------|--------|-------|-----|--------|
| [Atari 800XL](atari/800xl.md) | BASIC READY; types | beam GTIA (per-CC colour); fixed-DMA | mcp | Yes | ✅ |
...
| [Atari 5200](atari/5200.md) | Pac-Man menu | beam GTIA (per-CC colour); fixed-DMA | mcp | No | ✅ (offline) |
