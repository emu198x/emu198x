...
- **Mapper system** — NROM, MMC1, UxROM, CNROM, MMC3, AxROM, BxROM/BNROM, NINA-001, and Camerica/Codemasters are implemented; the remaining long-tail mappers are compatibility-driven
...
| `format-nintendo-nes-ines` | iNES parser + NROM/MMC1/UxROM/CNROM/MMC3/AxROM/BxROM/NINA-001/Camerica mappers | Active |
