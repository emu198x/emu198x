...
- **Mapper system** — NROM, MMC1, UxROM, CNROM, and MMC3 are implemented; the remaining long-tail mappers are compatibility-driven
...
| `format-nintendo-nes-ines` | iNES parser + NROM/MMC1/UxROM/CNROM/MMC3 mappers | Active |
