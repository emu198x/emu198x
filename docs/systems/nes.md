...
- **Mapper system** — NROM, MMC1, UxROM, CNROM, MMC3, and AxROM are implemented; the remaining long-tail mappers are compatibility-driven
...
| `format-nintendo-nes-ines` | iNES parser + NROM/MMC1/UxROM/CNROM/MMC3/AxROM mappers | Active |
