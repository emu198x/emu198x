...
- **Mapper system** — NROM, MMC1, UxROM, CNROM, MMC3, AxROM, BxROM/BNROM, and Camerica/Codemasters are implemented; the remaining long-tail mappers are compatibility-driven
...
| `format-nintendo-nes-ines` | iNES parser + NROM/MMC1/UxROM/CNROM/MMC3/AxROM/BxROM/Camerica mappers | Active |
