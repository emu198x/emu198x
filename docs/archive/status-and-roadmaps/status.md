...
| NES      | Production-ready       | NTSC and PAL cartridge support, 14 mappers, battery-backed PRG RAM; 32/35 Blargg sub-tests pass                                | [systems/nes.md](systems/nes.md)           |
| Amiga    | Production-ready       | OCS/ECS/AGA across 10 models (A500–A4000), Workbench 1.3 desktop, ADF/IPF media, 1541-style floppy | [systems/amiga.md](systems/amiga.md)       |
...
At dashboard level: A500 boots to Workbench 1.3 desktop. A1000/A2000/A500+/A600
boot to insert-disk with OCS or ECS. A1200 boots to AGA insert-disk. A3000
boots to insert-disk with KS 3.1 (KS 2.02 blocked by ROM-level scsi.device
task-switch issue). A4000 boots to AGA insert-disk with KS 3.1 (floppy icon
body missing — sprite rendering gap). CDTV/CD32 are not started.
