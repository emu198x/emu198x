#!/usr/bin/env python3
"""Build the player/missile DMA probe cartridge for the Atari 800XL.

`atari-800xl-pm-dma.s` is a program this project wrote, so the image can sit
...
is `crates/machine-atari-800xl/tests/pm_dma.rs`; what the cartridge does and
...
SOURCE = HERE / "atari-800xl-pm-dma.s"
IMAGE = HERE / "atari-800xl-pm-dma.bin"
CART_SIZE = 8 * 1024
