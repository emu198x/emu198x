#!/usr/bin/env python3
"""Build the GTIA mode probe cartridge for the Atari 800XL.

`atari-800xl-gtia-modes.s` is a program this project wrote, so the image can sit
...
is `crates/machine-atari-800xl/tests/gtia_modes.rs`; what the cartridge does and
...
SOURCE = HERE / "atari-800xl-gtia-modes.s"
IMAGE = HERE / "atari-800xl-gtia-modes.bin"
CART_SIZE = 8 * 1024
