...
explicit Test Kit video-conformance lane. Each reference family fixes the
...
external ADF and firmware identities shared by the collection. The
[video-conformance process](../../knowledge/processes/amiga-test-kit-video-conformance.md)
defines how the explicit lane consumes these references and how a result may
be interpreted.
...
The current collection contains the
[A500+A501 OCS PAL vAmiga reference](a500-a501-ocs-pal/README.md).
